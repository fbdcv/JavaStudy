...
参考文章：[ Java多线程之----主线程会等待子线程结束再结束么，怎么让主线程等待子线程结束呐](https://blog.csdn.net/wcc178399/article/details/106586708)

### 如何让主线程等子线程执行完之后再执行

参考文章：[如何让主线程等子线程执行完之后再执行](https://blog.csdn.net/b521626/article/details/102926773)